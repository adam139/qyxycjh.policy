...
from qyxycjh.policy.testing import POLICY_INTEGRATION_TESTING as INTEGRATION_TESTING
from qyxycjh.policy.setuphandlers import STRUCTURE,_create_content
from qyxycjh.policy.migration import _create_article
#sqlarchemy
...
#         self.assertTrue('Lorem ipsum' in output)
    ...
    def test_project_query(self):
        from qyxycjh.policy.mapping_db import  Project
        from qyxycjh.policy.interfaces import IProjectLocator
        from zope.component import getUtility
        from qyxycjh.policy import Session as session
    ...
    def test_Donor_query(self):
        from qyxycjh.policy.mapping_db import  Donor
        from qyxycjh.policy.interfaces import IDonorLocator
        from zope.component import getUtility
    ...
    def test_donate_query(self):
        ...
        from qyxycjh.policy.interfaces import IDonateLocator
        from zope.component import getUtility
    ...
    def test_volunteerteam_query(self):
        from qyxycjh.policy.mapping_db import  Volunteerteam
        from qyxycjh.policy.interfaces import IVolunteerteamLocator
        from zope.component import getUtility
        from qyxycjh.policy import Session as session
...
#         from qyxycjh.policy.model import Screening
#         from qyxycjh.policy.interfaces import IScreeningLocator
#         from zope.component import getUtility
...
#         from qyxycjh.policy.model import Screening
#         from qyxycjh.policy.reservation import Reservation
#         from qyxycjh.policy.interfaces import ITicketReserver
#         from z3c.saconfig import Session
#         from zope.component import getUtility
#
#         model = Screening()
...
#
#         from qyxycjh.policy.interfaces import ITicketReserver
#         from qyxycjh.policy.interfaces import ReservationError
#         from z3c.saconfig import Session
#         from zope.component import getUtility
#
#         model = Screening()
