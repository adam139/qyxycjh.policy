...
from qyxycjh.policy.content.memberfolder import IMemberfolder
...
class MemberFolderView(grok.View):
    ...
    def getOrgInfFromBrain(self, brain, orgid):
        ...
        if brain.portal_type == 'qyxycjh.policy.organizationmember':
            ...
            exec("from qyxycjh.policy.content.governmentdepartment import IOrgnization as Intf")
    ...
    def getMemberList(self):
        ...
        for brain in memberbrains:
            ...
            if brain.portal_type == 'dexterity.membrane.organizationmember':
                ...
                exec(
                    "from qyxycjh.policy.content.governmentdepartment import IOrgnization as Intf")
                row['type'] = self.getOrgFromId(Intf, id)
